...
export function Footer() {
  return (
    <footer className="border-t border-hairline px-6 py-12 mt-24">
      <div className="max-w-7xl mx-auto flex flex-col gap-8 md:grid md:grid-cols-3 md:items-center text-center md:text-left">
        <div className="font-display text-2xl font-extrabold tracking-tighter">
          DevRoman<span className="text-accent">.pl</span>
        </div>
        <div className="flex flex-wrap justify-center gap-x-6 gap-y-3 text-[11px] uppercase tracking-[0.2em] text-foreground/50">
